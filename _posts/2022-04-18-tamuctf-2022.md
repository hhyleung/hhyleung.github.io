...
The banner editor at [https://www.needcoolshoes.com/banner](https://www.needcoolshoes.com/banner) was used to import the json to reveal the how each of the individual banner looks and hence obtained the flag.
